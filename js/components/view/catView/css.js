...
const filteredCssPosts = document.createElement('div');
filteredCssPosts.className = 'container mostreadposts';
...
filteredCssPosts.appendChild(newPostsCategoryTitle);
filteredCssPosts.appendChild(tomatoProgressive);
...
const filteredPosts = posts.filter((post) => post.category === 'css');
...
filteredCssPosts.appendChild(newPostsCard);
export { filteredCssPosts };
