...
const filteredJavaScriptPosts = document.createElement('div');
filteredJavaScriptPosts.className = 'container mostreadposts';
...
filteredJavaScriptPosts.appendChild(newPostsCategoryTitle);
filteredJavaScriptPosts.appendChild(tomatoProgressive);
...
const filteredPosts = posts.filter((post) => post.category === 'javascript');
...
filteredJavaScriptPosts.appendChild(newPostsCard);
export { filteredJavaScriptPosts };
